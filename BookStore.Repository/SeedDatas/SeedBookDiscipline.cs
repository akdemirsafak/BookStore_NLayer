...
public class SeedBookDiscipline : IEntityTypeConfiguration<BookDiscipline>
{
    ...
    {
        builder.HasData(
            new BookDiscipline { BookId = 1, DisciplineId = 2 },
            new BookDiscipline { BookId = 2, DisciplineId = 1 },
            new BookDiscipline { BookId = 2, DisciplineId = 2 },
            new BookDiscipline { BookId = 3, DisciplineId = 1 },
            new BookDiscipline { BookId = 3, DisciplineId = 2 },
            new BookDiscipline { BookId = 3, DisciplineId = 6 },
            new BookDiscipline { BookId = 4, DisciplineId = 2 },
